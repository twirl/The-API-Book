### Проблемы встраивания UI-компонентов
...
[![APP](/img/mockups/01.size-s.png "Основной экран приложения с результатами поиска")]()
...
[![APP](/img/mockups/02.size-s.png "Панель просмотра предложения")]()
...
[![APP](/img/mockups/03.size-s.png "Результаты поиска с иконкой кофейни")]()

Теперь предположим, что разработчик также переопределил внешний вид всех кнопок в SDK, добавив иконки действий.

[![APP](/img/mockups/04.size-s.png "Панель показа предложения с иконками действий")]()

...
**Другая альтернатива** — использование техник оптимистичного управления параллелизмом, о которых мы поговорим в главе «[Стратегии синхронизации](#api-patterns-sync-strategies)».
